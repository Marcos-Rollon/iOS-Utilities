...
struct FormatDisplay {
    ...
    ///Date from Date to string formatted in dd-MM-yyyy HH:mm:ss
    ...
    ///Date from Date to string formatted in dd-MM-yy HH:mm
    ...
    ///Date from Date to string in dd-MM-yy
    ...
    ///Translates an (Int) for the difficulty level to a localized String
    static func difficultyLocalized(diff : Int) -> String{
        if diff == 0{
